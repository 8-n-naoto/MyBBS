            ...
            <div class="flex-row">
                <div class="flex-column">
                    ...
                    <form method="post" action="{{ route('cakes.cake.update', $cakeinfo) }}" enctype="multipart/form-data"
                        ...
                        <div class="flex-row">
                            <div class="flex-column">
                                <img src="{{ asset($info->mainphoto) }}" class="management-photo" alt="ケーキの写真"
                                    accept=".jpg,.png">
                            </div>
                            <div class="flex-column">
                                {{-- 写真の選択 --}}
                                ...
                                <div class="flex-row">
                                    <div>
                                        ...
                                        <div class="flex-row">
                                            ...
                                            <div class="flex-column">
                                                <input type="text" name="cakename" size="20"
                                                    value="{{ $info->cakename }}" class="value-font cakeform">
                                                @error('cakename')
                                                    <div class="error">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="flex-row">
                                            ...
                                            <div class="flex-column">
                                                <input type="text" name="cakecode" size="7"
                                        ...
                                        <div class="flex-row">
                                            ...
                                            <div class="flex-column">
                                                <input type="text" name="topic" size="20"
                                                    value="{{ $info->topic }}" class="value-font cakeform">
                                                @error('topic')
                                                    <div class="error">{{ $message }}</div>
                                                @enderror
                                            </div>
                    ...
                    <form method="post" action="{{ route('cakes.cake.destroy', $info) }}"
                        class="delete flex-row item-end">
                        @method('DELETE')
                        @csrf
                ...
                <div class="flex-culomn">
                    ...
                    {{-- タグに関する表示 --}}
                    <h3 class="form-font">&laquo;設定タグ追加と一覧&raquo;</h3>
